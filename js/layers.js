addLayer("r", {
	...
	if (hasUpgrade('rr', 31)) mult = mult.pow(upgradeEffect('rr', 31))
	if (hasUpgrade('pp', 12)) mult = mult.pow(1e100)
...
addLayer("rr", {
	...
	upgrades: {
		...
		24: {
            ...
            effect() {
                return player.rr.points.add(10).log10().pow(40).mul(1000)
            },
            effectDisplay() { return format(upgradeEffect(this.layer, this.id))+"x" }, // Add formatting to the effect
		},
		31: {
		...
		41: {
            ...
            effect() {
                return player.points.add(10).log10().log(10).add(1).mul(20)
            },
            effectDisplay() { return format(upgradeEffect(this.layer, this.id))+"x" }, // Add formatting to the effect
		},
		42: {
            ...
            effect() {
                return player.r.points.add(10).log10().log(10).add(1).mul(20)
            },
            effectDisplay() { return format(upgradeEffect(this.layer, this.id))+"x" }, // Add formatting to the effect
		},
		43: {
            ...
            effect() {
                return player.p.points.add(10).log10().log(10).add(1).mul(20)
            },
            effectDisplay() { return format(upgradeEffect(this.layer, this.id))+"x" }, // Add formatting to the effect
		},
		44: {
            ...
            effect() {
                return player.c.points.add(10).log10().log(10).add(1).mul(20)
            },
            effectDisplay() { return format(upgradeEffect(this.layer, this.id))+"x" }, // Add formatting to the effect
		},
		},
	...
	if (hasUpgrade('rr', 32)) mult = mult.pow(upgradeEffect('rr', 32))
	if (hasUpgrade('pp', 13)) mult = mult.pow(1e100)
	if (inChallenge('d', 11)) mult = mult.pow(0.0001)
 	if(mult.gte("e1e12")) mult=mult.div("e1e12").pow(0.1).mul("e1e12")
 	if(mult.gte("e1e15")) mult=mult.div("e1e15").pow(0.01).mul("e1e15")
 	if(mult.gte("e1e18")) mult=mult.div("e1e18").pow(0.0001).mul("e1e18")
	...
	if (hasUpgrade('rr', 33)) mult = mult.pow(upgradeEffect('rr', 33))
	if (hasUpgrade('pp', 14)) mult = mult.pow(1e100)
	if (inChallenge('d', 11)) mult = mult.pow(0.0001)
 	if(mult.gte("e1e12")) mult=mult.div("e1e12").pow(0.1).mul("e1e12")
 	if(mult.gte("e1e15")) mult=mult.div("e1e15").pow(0.01).mul("e1e15")
 	if(mult.gte("e1e18")) mult=mult.div("e1e18").pow(0.0001).mul("e1e18")
	...
	if (hasUpgrade('rr', 34)) mult = mult.pow(upgradeEffect('rr', 34))
	if (hasUpgrade('pp', 21)) mult = mult.pow(1e100)
 	if(mult.gte("e1e12")) mult=mult.div("e1e12").pow(0.1).mul("e1e12")
 	if(mult.gte("e1e15")) mult=mult.div("e1e15").pow(0.01).mul("e1e15")
 	if(mult.gte("e1e18")) mult=mult.div("e1e18").pow(0.0001).mul("e1e18")
 	if(mult.gte("e1e21")) mult=mult.div("e1e21").pow(1e-8).mul("e1e21")
